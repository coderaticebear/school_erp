...
- **Headings:** one `<h1>` per page, in `@section('content_header')`, plus `@section('title', ...)`. Card titles are `<h2 class="card-title">`. Dashboard numbers use `<p class="small-box-value">`, not headings.
